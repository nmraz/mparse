...
inline void print_locs(std::string_view source, std::initializer_list<mparse::source_range> underline_locs) {
  print_locs(source, util::span(&*underline_locs.begin(), underline_locs.size()));
}
